...
const Hero = () => {
  ...
  return (
    <div className="min-h-screen w-full">
      <div className="pt-12 sm:pt-24 flex flex-col justify-center sm:grid sm:grid-cols-2 place-items-center px-6 w-full h-full">
        <div className="left-col">
          ...
          <div className="flex gap-4 mt-4 justify-center items-center sm:justify-start">
            ...
            {user ? (
              ...
              <Link to="/businesses/new-listing">
                <button className="btn btn-lg btn-secondary">
                  Start Earning
                </button>
              </Link>
          ...
          {/** TODO: 4 square img container */}
          <div className="flex items-center justify-center">4 Square</div>
        </div>
